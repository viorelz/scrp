...
.host = "127.0.0.1";
.port = "80";
.first_byte_timeout = 21602s;
.between_bytes_timeout = 21602s;
}
acl crawler_acl {
"127.0.0.1";
}
...
if (req.url ~ "^(/media/|/skin/|/js/|/)(?:(?:index|litespeed)\.php/)?(?:admin|api|cron\.php|pnsfortueberweisung|index\.php|invoices|invoice|Invoice|Invoices|Itabs|media/invoices|checkout|Mash2_Cobby|admin|customer|catalog|catalogsearch|catalog/product_compare|index.php|wishlist)" ||
